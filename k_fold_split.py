...
class Stratified_group_k_fold:
    ...
    def __post_init__(self):
        self.filename_column = self.csv_config["file_col"]  # ファイル列
        self.label_column = self.csv_config["tag_col"]  # ラベル列
        self.group_column = self.csv_config["ID_col"]  # グループ列
    ...
    def k_fold_classifier(self, df):
        ...
        # グループ層化K分割
        os.makedirs(self.split_info_folder, exist_ok=True)
